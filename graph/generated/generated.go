...
func (ec *executionContext) _Currency_amount(ctx context.Context, field graphql.CollectedField, obj *api.Currency) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Currency(ctx context.Context, sel ast.SelectionSet, obj *api.Currency) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "amount":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Currency_amount(ctx, field, obj)
			}
